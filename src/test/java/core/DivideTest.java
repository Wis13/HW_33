...
import static org.hamcrest.Matchers.*;
	public class DivideTest {
       ...
       public void divide_test_2_param() {
              assertThat(Calculator.divide(5.1, 2.0), closeTo(2.5 , 0.9));}

       @Test
       public void divide_test_3_param() {
              assertThat(Calculator.divide(10, 3, 2), closeTo(1.6 , 0.9));}

       @Test
       public void divide_test_4_param() {
              assertThat(Calculator.divide(22, 4, 3, 2), closeTo(0.9 , 0.9));}
}